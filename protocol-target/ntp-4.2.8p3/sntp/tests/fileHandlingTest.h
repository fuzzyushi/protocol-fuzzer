...
const char * CreatePath(const char* filename, enum DirectoryType argument) {
	...
	*/
	...
	printf("builddir is   <.>\n");
	printf("abs_srcdir is </home/situlingyun/Documents/protocol-fuzzer/protocol-target/ntp-4.2.8p3/sntp/tests>\n");
	strcpy(path,"/home/situlingyun/Documents/protocol-fuzzer/protocol-target/ntp-4.2.8p3/sntp/tests/data/");
